    ...
    >
      ...
      <section className="relative z-10 pt-[8.6rem] mt:pt-[7.9rem] lg:pt-[6.5rem] xl:pb-[3.3rem] sm:pb-14 w-full max-w-5xl mx-auto flex flex-col justify-center items-center">
        <motion.h1
          ...
          initial="initial"
          animate="animate"
          className="font-title font-black tracking-wide text-[1.9rem] sm:text-[2.1rem] mt:text-[2.2rem] md:text-[2.3rem] lg:text-[2.65rem] xl:text-[2.8rem] cursor-default text-center mb-[0.3rem] text-blue-dark"
        >
        ...
        <motion.h2
          ...
          initial="initial"
          animate="animate"
          className="font-subtitle font-normal cursor-default text-base sm:text-lg md:text-xl lg:text-2xl xl:text-3xl text-center text-gray-link tracking-wide"
        >
